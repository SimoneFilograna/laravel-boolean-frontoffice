...
<template>
    <div class="container">
        <h1 class="text-center mt-5 style-text">Cocktail's Family</h1>
        <p class="text-center mb-5 fst-italic">A little story about us</p>
        <div class="d-flex col-10 row text-center justify-content-center m-auto">

                <div class="col-12 col-lg-6 m-auto my-4">
                    <img style="width: 100%;" src="../assets/images/main.jpeg">
                </div>

            <div class="desc-box col-12 col-lg-6 m-auto my-4">
                <p> Attraversando il famoso varco di Via Brombeis di Napoli, si raggiunge il Cocktail Lounge, 
                    ...
                    ci siamo specializzati in agenti di commercio che si alzano alle 07:30, che hanno il fisico, si eh, che arrivano al lavoro
                    freschi come una rosa, perchè a clientela così un locale del genere può accompagnare solo.</p>
            </div>
        </div>
    </div>
</template>
